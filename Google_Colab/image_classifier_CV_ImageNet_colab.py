...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(base_dir, 'Google_Colab', 'ImageNet_Classified_Images')
    csv_output_file = os.path.join(base_dir, 'Google_Colab', 'imagenet_classification_results.csv')
