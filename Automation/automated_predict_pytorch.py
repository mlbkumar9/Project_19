...
# --- 1. Prediction Function (Corrected) ---
...
def main():
    ...
    # --- Argument Parser ---
    parser = argparse.ArgumentParser(description='Predict with PyTorch U-Net model using a specified backbone.')
    parser.add_argument('--backbone', type=str, default='resnet50',
                        help='Name of the backbone model to use for prediction.')
