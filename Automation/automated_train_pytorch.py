...
def main():
    ...
    # --- Argument Parser ---
    parser = argparse.ArgumentParser(description='Train PyTorch U-Net model with a specified backbone.')
    ...
    # --- Model Initialization using segmentation-models-pytorch ---
    device = get_device()
