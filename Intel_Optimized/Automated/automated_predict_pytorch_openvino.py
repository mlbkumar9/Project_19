...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Error: PyTorch backbone not provided as a command-line argument.")
        sys.exit(1)
    ...
    OUTPUT_DIR = os.path.join(BASE_DIR, 'Predictions', 'Pytorch', f'{BACKBONE}_onnx')
    ONNX_MODEL_PATH = os.path.join(BASE_DIR, 'Trained_Models', 'Pytorch', f'smp_unet_{BACKBONE}.onnx')
